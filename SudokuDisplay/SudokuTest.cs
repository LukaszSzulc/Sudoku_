namespace SudokuDisplay
{
    ...
    public class SudokuTest
    {
        ...
        public static SquareCollection CreateSquareCollection()
        {
            ...
            squareCollection.AddSquare(
                new Square(1, 1, SquareBuilder.Create().Add(0, 2, 3).Add(1, 2, 4).Add(2, 1, 8).Build()));
            ...
            squareCollection.AddSquare(
                new Square(2, 2, SquareBuilder.Create().Add(0, 2, 4).Add(1, 0, 5).Add(2, 1, 8).Build()));
